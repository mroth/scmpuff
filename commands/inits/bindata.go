...
func dataGit_wrapperSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/git_wrapper.sh", size: 698, mode: os.FileMode(420), modTime: time.Unix(1426541666, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dataStatus_shortcutsSh() (*asset, error) {
	...
	info := bindataFileInfo{name: "data/status_shortcuts.sh", size: 1288, mode: os.FileMode(420), modTime: time.Unix(1426541666, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
